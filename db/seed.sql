...
VALUES
    ('xyRPCR99eFMuy370hJNsXqQTMMs2',1,'point guard', 'lisadoe@mail.com', 'user1', 'Lisa', 'Andreev', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815634/H2H/avdalyan-DQjWG8NBGWg-unsplash_qg15ht.jpg', '1990-01-01', 2, 1, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('JUJBze4P0iTyo7Md1VJOSGFffza2',1,'shooting guard', 'annadoe@mail.com', 'user2', 'Anna', 'Davies', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815632/H2H/christine-murphy-ld0SijDh-SI-unsplash_sgao3c.jpg', '1995-05-15', 2, 1, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('imJcQHgkU8dvCLTYIU5HHR46YGH2',1,'small forward', 'olga@mail.com', 'user3', 'Olga', 'Klimenta', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815631/H2H/brian-lawson-PY3VNWIDYhE-unsplash_dzx7dp.jpg', '1988-09-30', 2, 1, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('ZtVGe5s5XXQmeuPhXwgwcBphGKd2',1, 'power forward', 'lilydoe4@mail.com', 'user4', 'Lily', 'Diaz', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815638/H2H/anupam-roy-993qsAlrjQs-unsplash_raicsd.jpg', '1992-03-18', 2, 1, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('JiFzRM68oAh5eKEp7g4aHe5pmkh2',1, 'center', 'jeffdoe@mail.com', 'user5', 'Jeff', 'Lopez', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815635/H2H/brian-lundquist-7B4zs9M8rYI-unsplash_x8ocgj.jpg', '1993-07-25', 2, 1, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('pEG6Va8IRzgJD8ajBno0jWuJijC2',2, 'point guard','barrydoe@mail.com', 'user6', 'Barry', 'White', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815637/H2H/andre-sebastian-C2Nf5iPOnz0-unsplash_xko2bi.jpg', '1994-11-12', 1, 2, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('SHllyhGebWfURlPFvFARgg7ao6w2',2, 'shooting guard','janedoe@mail.com', 'user7', 'Jane', 'Abbas', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815645/H2H/gideon-hezekiah-WCEMFqEIVek-unsplash_yo1e1o.jpg', '1989-04-02', 1, 2, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('CYTa0byE4wNwp4ihgKDKHndw4eM2',2, 'small forward', 'johndoe@mail.com', 'user8', 'John', 'Cortez', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815642/H2H/courtney-hill-b7P2CrRhYf0-unsplash_aplghx.jpg', '1991-08-20', 1, 2, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('C9vRjJatYEdejvHJBMqNaoaegyK2',2, 'power forward','gretadoe@mail.com', 'user9', 'Greta', 'Medina', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815645/H2H/dillon-kydd-tHk6m4vgMys-unsplash_b7rbcs.jpg', '1996-02-14', 1, 2, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('FPvHHVh1M5Rwd45SbQmsXZn00pl2',2, 'center','ericdoe@mail.com', 'user10', 'Eric', 'Matthews', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815647/H2H/emrecan-arik-apJKb2Js_Vg-unsplash_qjrslb.jpg', '1997-06-30', 1, 2, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

    ('1VkAfJdTH5OSZtrqvpexsCMPMyx2',3, 'point guard','barneydoe@mail.com', 'user11', 'Barney', 'Omar', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815656/H2H/julian-myles-I2g6Oe9ElbE-unsplash_ivqnx0.jpg', '1994-11-12', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('nY3Kz1iJifVRfIRHlvSmzI7zoW03',3, 'shooting guard','janettdoe@mail.com', 'user12', 'Janett', 'Dawson', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815651/H2H/gabriel-silverio-u3WmDyKGsrY-unsplash_glpbn7.jpg', '1989-04-02', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('aWcL4rlAFLSndBJAFESnBSjHzYz2',3, 'small forward', 'johnnydoe@mail.com', 'user13', 'Johnny', 'Lewis', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815659/H2H/josh-scorpio-H3Tuh0hwYQk-unsplash_ohgnai.jpg', '1991-08-20', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('xNQDT50b1ubAnFGeQ1wMTHZNspI2',3, 'power forward','grootdoe@mail.com', 'user14', 'Groot', 'Nowak', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815665/H2H/karsten-winegeart-Nz0d2wxw0t4-unsplash_hwadtn.jpg', '1996-02-14', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('q6yZqvIn8SgYaajKDCpXbXjpEsJ2',3, 'center','ericadoe@mail.com', 'user15', 'Erica', 'Britton', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815654/H2H/jason-moyer-7JmGPyljOSE-unsplash_vytxg2.jpg', '1997-06-30', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

    ('hBylnkSsVUUjNhlCBAtTnX2EN893', 4, 'point guard', 'desireedoe@mail.com', 'user16', 'Desiree', 'Belmonte', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815661/H2H/kimson-doan-HD8KlyWRYYM-unsplash_strpc2.jpg', '1995-03-18', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

    ('3lHMYdPmI5ejx41vf4A3zASoz0g2', 5, 'point guard', 'matthewdoe@mail.com', 'user17', 'Matthew', 'Powers', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815665/H2H/karabo-mdluli-nRwJaWg7McU-unsplash_hcuaid.jpg', '1993-12-05', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    
    ('LUrxqd3Ov9TuYPVWOHcx6ysaEOg1', NULL, 'shooting guard', 'adeledoe@mail.com', 'user18', 'Adele', 'Jackson', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815673/H2H/omid-armin-g9dpfgrSyR8-unsplash_ng4vc0.jpg', '1988-09-22', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('9YGrpeiOfpTW3vHwEblaxHoor3n2', NULL, 'power forward', 'britneydoe@mail.com', 'user19', 'Britney', 'Spearmint', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815684/H2H/prince-akachi-J1OScm_uHUQ-unsplash_kocdrs.jpg', '1990-11-08', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Qh1UJsv9pfUOhAEkcmIHbvww3ly1', NULL, 'center', 'leodoe@mail.com', 'user20', 'Leo', 'Smith', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815691/H2H/rodney-gainous-jr-p_VF71muhRs-unsplash_eppcl1.jpg', '1987-07-15', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
