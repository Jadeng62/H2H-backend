...
CREATE TABLE team (
    ...
    logo VARCHAR(255),
    player1_id VARCHAR(255) REFERENCES users(id) ON DELETE CASCADE,
    player2_id VARCHAR(255) REFERENCES users(id) ON DELETE CASCADE,
    player3_id VARCHAR(255) REFERENCES users(id) ON DELETE CASCADE,
    player4_id VARCHAR(255) REFERENCES users(id) ON DELETE CASCADE,
    player5_id VARCHAR(255) REFERENCES users(id) ON DELETE CASCADE,
    captain_id VARCHAR(255) REFERENCES users(id) ON DELETE CASCADE,
    team_wins INTEGER,
    team_loss INTEGER,
