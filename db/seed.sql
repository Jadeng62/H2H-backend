...
VALUES
    (1,'xyRPCR99eFMuy370hJNsXqQTMMs2',1,'point guard', 'lisadoe@mail.com', 'user1', 'Lisa', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815634/H2H/avdalyan-DQjWG8NBGWg-unsplash_qg15ht.jpg', '1990-01-01', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2,'JUJBze4P0iTyo7Md1VJOSGFffza2',1,'shooting guard', 'annadoe@mail.com', 'user2', 'Anna', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815632/H2H/christine-murphy-ld0SijDh-SI-unsplash_sgao3c.jpg', '1995-05-15', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (4,'ZtVGe5s5XXQmeuPhXwgwcBphGKd2',1, 'power forward', 'lilydoe4@mail.com', 'user4', 'Lily', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815638/H2H/anupam-roy-993qsAlrjQs-unsplash_raicsd.jpg', '1992-03-18', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (5,'JiFzRM68oAh5eKEp7g4aHe5pmkh2',1, 'center', 'jeffdoe@mail.com', 'user5', 'Jeff', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815635/H2H/brian-lundquist-7B4zs9M8rYI-unsplash_x8ocgj.jpg', '1993-07-25', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6,'pEG6Va8IRzgJD8ajBno0jWuJijC2',2, 'point guard','barrydoe@mail.com', 'user6', 'Barry', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815637/H2H/andre-sebastian-C2Nf5iPOnz0-unsplash_xko2bi.jpg', '1994-11-12', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (7,'SHllyhGebWfURlPFvFARgg7ao6w2',2, 'shooting guard','janedoe@mail.com', 'user7', 'Jane', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815645/H2H/gideon-hezekiah-WCEMFqEIVek-unsplash_yo1e1o.jpg', '1989-04-02', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (8,'CYTa0byE4wNwp4ihgKDKHndw4eM2',2, 'small forward', 'johndoe@mail.com', 'user8', 'John', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815642/H2H/courtney-hill-b7P2CrRhYf0-unsplash_aplghx.jpg', '1991-08-20', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (9,'C9vRjJatYEdejvHJBMqNaoaegyK2',2, 'power forward','gretadoe@mail.com', 'user9', 'Greta', 'Doe', 'https://res.cloudinary.com/dwygxzqku/image/upload/v1720815645/H2H/dillon-kydd-tHk6m4vgMys-unsplash_b7rbcs.jpg', '1996-02-14', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
