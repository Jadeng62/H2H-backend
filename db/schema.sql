...
CREATE TABLE team (
    ...
    logo VARCHAR(255),
    point_guard_id INT REFERENCES users(id) ON DELETE CASCADE,
    shooting_guard_id INT REFERENCES users(id) ON DELETE CASCADE,
    small_forward_id INT REFERENCES users(id) ON DELETE CASCADE,
    power_forward_id INT REFERENCES users(id) ON DELETE CASCADE,
