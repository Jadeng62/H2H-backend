...
VALUES
    ...
    ('jbxWhN2nnUeAst3717q6nSHKe9f1',2, 'point guard','barrydoe@mail.com', 'user6', 'Barry', 'Doe', 'user6.jpg', '1994-11-12', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    ('Udq3thBeYwTXZP6K7Z7WWN78kBp1',2, 'power forward','gretadoe@mail.com', 'user9', 'Greta', 'Doe', 'user9.jpg', '1996-02-14', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- get ids for barry and greta from firebase auth table
-- barry:1
-- greta:2
...
VALUES
    ...
    ('Team B', 'team_b_pic.jpg', 'team_b_logo.jpg', '1', '2', 'SHllyhGebWfURlPFvFARgg7ao6w2', 'CYTa0byE4wNwp4ihgKDKHndw4eM2', 'FPvHHVh1M5Rwd45SbQmsXZn00pl2', '1', 0, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
